...
`src/frontend/public/maps/bouldering.png` and `routes.png` ship with the app and are served at `/maps/*.png`. They came from screenshots of KAYA's in-app maps with the climb-count bubbles painted out; the area labels are the gym's own names.
